<section class="catalog">
    <div class="container">
        <div class="catalog__body">
            ...
            $booksDB = $db->query("SELECT `category`.`name`, `category`.`color`, `books`.`title`, `books`.`text`, `books`.`author`, `books`.`img`, `books`.`category_id` FROM  `books` INNER JOIN  `category` ON `books`.`category_id` = `category`.`id`");
